...
@Component({
  selector: 'app-boxplot-tremor-patient',
  templateUrl: './boxplot-tremor-patient.component.html',
  styleUrls: ['./boxplot-tremor-patient.component.scss']
})
export class BoxplotTremorPatientComponent implements OnInit {
